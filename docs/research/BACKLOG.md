...
> **Migrated from RESEARCH.md** — See [RESEARCH.md](../../RESEARCH.md) for process. Before documenting, check if the topic belongs in an existing consolidated file.
...
- [x] [vscode-copilot-settings](https://code.visualstudio.com/docs/copilot/setup) → [RDR-014](archive/RDR-014-vscode-copilot-settings.md) (consolidated → [vscode-platform.md](vscode-platform.md))
- [x] [copilot-agent-tools](https://code.visualstudio.com/docs/copilot/reference/copilot-vscode-features) → [RDR-015](archive/RDR-015-copilot-agent-tools.md) (consolidated → [vscode-platform.md](vscode-platform.md))
- [x] [vscode-1.108-skills](https://code.visualstudio.com/updates/v1_108) → [RDR-014](archive/RDR-014-vscode-copilot-settings.md) (consolidated → [vscode-platform.md](vscode-platform.md))
- [x] [vscode-browser-testing](https://code.visualstudio.com/docs/copilot/overview) → [RDR-013](RDR-013-vscode-browser-testing.md)
- [x] [vscode-1.109](https://code.visualstudio.com/updates/v1_109) → [RDR-031](archive/RDR-031-vscode-1109-orchestration.md) (consolidated → [vscode-platform.md](vscode-platform.md))
...
- [x] [feature-dev-plugin](https://github.com/anthropics/claude-plugins-official/tree/main/plugins/feature-dev) → [RDR-003](archive/RDR-003-feature-dev.md) (consolidated → [external-patterns.md](external-patterns.md))
...
- [x] [six-tips-agents](https://steve-yegge.medium.com/six-new-tips-for-better-coding-with-agents-d4e9c86e42a9) → [RDR-022](archive/RDR-022-six-tips-agents.md) ⭐ (consolidated → [external-patterns.md](external-patterns.md))
- [x] [ralph-wiggum](https://github.com/anthropics/claude-code/tree/main/plugins/ralph-wiggum) → [RDR-023](archive/RDR-023-ralph-wiggum.md) ⭐ (consolidated → [external-patterns.md](external-patterns.md))
- [x] [claude-code-mastery](https://github.com/TheDecipherist/claude-code-mastery) → [RDR-024](archive/RDR-024-claude-code-mastery.md) (consolidated → [external-patterns.md](external-patterns.md))
...
- [x] Verify agent spec compatibility → [RDR-017](archive/RDR-017-agent-spec-compatibility.md) (consolidated → [ide-compatibility.md](ide-compatibility.md))
- [x] Improve testing of agents (install.sh, Claude Code configs)
- [x] Find opportunities to trim down agents (explore/implement)

### Skills

- [x] [superpowers](https://github.com/obra/superpowers) → [RDR-004](archive/RDR-004-superpowers.md) (consolidated → [skills-methodology.md](skills-methodology.md))
- [x] Review current skills → [RDR-019](archive/RDR-019-skill-review.md) (consolidated → [skills-methodology.md](skills-methodology.md))
...
- [x] Skill-powered subagents → [RDR-027](archive/RDR-027-skill-subagents.md) ⭐ (consolidated → [skills-methodology.md](skills-methodology.md))
- [x] [skills.sh](https://skills.sh/) ecosystem review → [RDR-028](archive/RDR-028-skills-sh.md) (consolidated → [skills-methodology.md](skills-methodology.md))
...
- [x] Subagents fork context? → [RDR-010](archive/RDR-010-subagents-context-fork.md) (consolidated → [context-management.md](context-management.md))
- [x] [planning-with-files](https://github.com/OthmanAdi/planning-with-files) → [RDR-012](archive/RDR-012-planning-with-files.md) ⭐ (consolidated → [context-management.md](context-management.md))
- [x] [copilot-memory](https://docs.github.com/en/copilot/concepts/agents/copilot-memory) → [RDR-025](archive/RDR-025-copilot-memory.md) ⭐ (consolidated → [context-management.md](context-management.md))
- [x] Create guidelines for plan file artifacts → Resolved: Use Research → Handoff workflow

### IDE Compatibility

- [x] [cursor-2.4](https://cursor.com/changelog/2-4) → [RDR-029](archive/RDR-029-alternative-ide-support.md) (consolidated → [ide-compatibility.md](ide-compatibility.md))
